# Recogonize joystick and ps4console with TensorFLow Lite Model Maker and Android Studio ML Model Binding

The link where this google colab file is located is:
https://colab.research.google.com/drive/1Gl0FT7M2fXLJYT0P2EbcUnCGB0CjAZXN?usp=sharing


This folder contains the code for the TensorFlow Lite codelab:

* [Recognize ps4 console and joystick with TensorFlow on Android (Beta)](https://goo.gle/3dbCSbt)
