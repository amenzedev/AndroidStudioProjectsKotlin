package com.example.automaticpassengercounter.utils
...
import com.example.automaticpassengercounter.MainActivity
...
class Draw(context: Context?, var rect: Rect, var text:String,var dimension_width:Int, var dimension_height:Int, var in_count:Int, var out_count:Int) : View(context) {
    ...
    private fun init(){
        ...
        doorPaint= Paint()
        doorPaint.color= Color.RED
        doorPaint.strokeWidth = 20f
        doorPaint.style = Paint.Style.STROKE
    ...
    override fun onDraw(canvas: Canvas?)
    {
        ...
        //canvas?.drawRect(50F,150F,MainActivity.width_boundary-50F,MainActivity.height_boundary-50F,doorPaint)
